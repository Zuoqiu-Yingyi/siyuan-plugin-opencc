...
import { convert, createConverter, Locale } from "./opencc";
...
import type { BlockMenuDetail, IBlockMenuContext, ISelectedMenuContext } from "@workspace/utils/siyuan/menu/block";

import type { IConverterOptions } from "./opencc";
